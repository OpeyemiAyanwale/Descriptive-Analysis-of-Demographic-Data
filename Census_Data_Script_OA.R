...
#############################
#8. Descriptive statistics for variables ######## for task 1 #######
...
#11. Correlation ####### for task 2 ############
attach(census_data2021) #so that i can mention a variable without writing the data

cor(total.fertility.rate, life.expectancy.females) # doesn't give p-value

cor(total.fertility.rate, life.expectancy.males)

cor(total.fertility.rate, life.expectancy.both.sexes)

#correlation between fertility rate and life expectancy of females
cor.test(total.fertility.rate, life.expectancy.females) # gives P-value but only works for bivariate correlation

#correlation between fertility rate and life expectancy of males
cor.test(total.fertility.rate, life.expectancy.males)

#correlation between fertility rate and life expectancy for both sexes
cor.test(total.fertility.rate, life.expectancy.both.sexes)
...
#abline(lm(life.expectancy.both.sexes~total.fertility.rate), col="green")
#legend("topleft",legend=paste("r is", corrmat[1,2]))
...
#abline(lm(life.expectancy.males~total.fertility.rate), col="red") to create a regression line
#legend("topleft",legend=paste("r is", corrmat[1,3]))
...
#abline(lm(life.expectancy.females~total.fertility.rate), col="blue")#regression line
#legend("topleft",legend=paste("r is", corrmat[1,4]))
...
#medians <- reorder (census_data2021$subregion, census_data2021$life.expectancy.both.sexes, median)
#boxplot(life.expectancy.both.sexes~ medians,data=census_data2021, main="Life Expectancy by Subregion",#
        #xlab="Life Expectancy Both Sexes", ylab="", horizontal=TRUE,las=2)#
